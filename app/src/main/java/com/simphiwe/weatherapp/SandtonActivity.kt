...
import com.simphiwe.weatherapp.viewmodel.WeatherViewModelSandton
import java.util.*

@AndroidEntryPoint
class SandtonActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMainBinding
    val viewModel: WeatherViewModelSandton by viewModels()
    private lateinit var fusedLocationProviderClient: FusedLocationProviderClient
    private val TAG = "Roodeport"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherResponseSandton.observe(this) { weather ->

            binding.apply {
                tvCityName.text = "Sandton"
