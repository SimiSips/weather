...
import com.simphiwe.weatherapp.viewmodel.WeatherViewModelPretoria
import java.util.*

@AndroidEntryPoint
class PretoriaActivity : AppCompatActivity() {
    ...
    val viewModel: WeatherViewModelPretoria by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherResponsePretoria.observe(this) { weather ->

            binding.apply {
                tvCityName.text = "Pretoria"
